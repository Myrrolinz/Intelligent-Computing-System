...
class VGG19(object):
    ...
    def build_model(self):
        ...
        # 5 个阶段的卷积层输出通道数分别为 64、128、256、512、512。
        # 最大池化层，将特征图的高和宽缩小为原来的 1/2
        self.layers = {}
    ...
    def load_image(self, image_dir):
        ...
        self.input_image = scipy.misc.imresize(self.input_image,[224,224,3]) # 调整图片大小
        self.input_image = np.array(self.input_image).astype(np.float32)
        self.input_image -= self.image_mean # 减去均值
